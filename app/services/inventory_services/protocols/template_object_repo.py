...
from domain.template_object.entities.template_object import TemplateObjectDTO
...
class TemplateObjectRepo(object):
    ...
    async def set_template_objects_invalid(
        self, template_objects: list[TemplateObjectDTO]
        ...
        if result:
            return [TemplateObjectDTO.from_db(template_obj) for template_obj in result]
        return []
